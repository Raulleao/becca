...
const roupas = [
  ...
  {
    image: "/images/saia_fundo_branco.png",
    name: "Saída de Praia",
    price: "R$ 150,00",
  ...
  {
    image: "/images/top_fundo_branco.png",
    name: "Top Cropped",
    price: "R$ 160,00",
    material: "Fio barbante",
  },
...
const bolsas = [
  ...
  {
    image: "/images/bolsaLuana.jpeg",
    name: "Bolsa Luana ",
    price: "R$ 110,00",
    description: "Trabalhada em fio barbante, 'fecho' de madeira.",
    material: "Fio barbante",
  },
];
...
const pecas = [
  ...
  {
    image: "/images/prendedorCortina.jpeg",
    name: "Prendedor Cortina",
    price: "R$ 65,00",
    description: "Funcionalidade com charme artesanal.",
  ...
  {
    image: "/images/estojo.png",
    name: "Estojo",
    price: "R$ 35,00",
    description: "Prático, bonito e multifuncional.",
    material: "Fio barbante",
  },
  {
    image: "/images/10.png",
  ...
  {
    image: "/images/portaFone.jpeg",
    name: "Porta Fone de Ouvido",
    price: "R$ 20,00",
    description: "Proteção para o seu fone de ouvido.",
    material: "Fio barbante ou Fio náutico",
  },
  {
    image: "/images/12.png",
    name: "Porta Copo",
      ...
      <main className="container mx-auto px-4 py-12">
        <section className="mb-20">
          <h2 className="text-4xl md:text-5xl font-display text-center mb-4">
            Catálogo de <span className="text-primary italic">Roupas</span>
          </h2>
          <p className="text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
            Todas as roupas são feitas à mão com muito carinho. As cores podem
            ...
            {roupas.map((roupas) => (
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-white to-secondary/20 p-8 flex items-center justify-center aspect-square">
                  <img
                    src={roupas.image || "/placeholder.svg"}
                    alt={roupas.name}
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="mt-auto pt-4 space-y-3">
                    <button
                      onClick={() => handleWhatsApp(roupas.name)}
